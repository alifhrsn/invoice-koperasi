...
begin
  ...
  -- Revisi memperbarui baris invoice asal. Nomor, ID, dan waktu terbit lama dipertahankan.
...
-- REFERENSI HARGA RETAIL / MARKETPLACE (BUKAN HARGA PASAR RESMI)
...
create policy "staf baca referensi retail" on public.retail_price_references for select to authenticated
  using ((select private.is_invoice_staff()));
